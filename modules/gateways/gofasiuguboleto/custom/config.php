...
// Não renomear a variável $gib_custom_config

$gib_custom_config_ = [ 
	// Opção 1
	'optiontest' => [ // Utilize $params['optiontest'] no arquivo /custom/params.php para incluir o valor dessa opção na função gofasiuguboleto_link
...
//$gib_custom_config = $gib_custom_config_;